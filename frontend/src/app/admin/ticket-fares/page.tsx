                                ...
                                <tr key={fare.id} className="hover:bg-slate-50/80 transition-colors group">
                                    ...
                                    <td className="py-3 px-5">
                                        {fare.image?.url ? (
                                            ...
                                            >
                                                <img src={getImageUrl(fare.image.url)} alt={fare.title} className="w-full h-full object-cover group-hover/img:scale-110 transition-transform duration-300" />
                        ...
                        <div>
                            ...
                            {formData.image_url && (
                                <div className="mt-3 w-full h-32 rounded-xl border border-slate-200 overflow-hidden shadow-sm relative group/thumb">
                                    <img src={getImageUrl(formData.image_url)} alt="Ticket Fare" className="w-full h-full object-cover" />
                                    <button
                                        type="button"
                                        onClick={() => {

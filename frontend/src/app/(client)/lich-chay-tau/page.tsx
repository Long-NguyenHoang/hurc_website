...
export default function SchedulePage() {
    ...
    return (
        <div className="w-full bg-white min-h-[75vh] pb-16 md:pb-24">
      ...
      `}} />
            ...
            <div className="max-w-[120rem] mx-auto px-4 lg:px-[56px] pt-8 md:pt-12">
                ...
                <div className="flex items-center justify-center gap-8 md:gap-16 mb-10">
                    ...
                    <button
                        ...
                        className={`pb-4 text-[16px] md:text-[18px] font-bold transition-all relative
